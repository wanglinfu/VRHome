...
public class DialogHelpUtils {
    ...
    public static AlertDialog.Builder getMessageDialog(Context context, String message, DialogInterface.OnClickListener onClickListener) {
        ...
        builder.setPositiveButton("" + context.getResources().getText(R.string.config), onClickListener);
        return builder;
    }
    ...
    public static AlertDialog.Builder getConfirmDialog(Context context, String message, DialogInterface.OnClickListener onClickListener) {
        ...
        builder.setPositiveButton("" + context.getResources().getText(R.string.config), onClickListener);
        builder.setNegativeButton(""+context.getResources().getText(R.string.cancle), null);
        return builder;
    }
    ...
    public static AlertDialog.Builder getConfirmDialog(Context context, String message, DialogInterface.OnClickListener onOkClickListener, DialogInterface.OnClickListener onCancleClickListener) {
        AlertDialog.Builder builder = getDialog(context);
        builder.setMessage(message);
        builder.setPositiveButton("" + context.getResources().getText(R.string.config), onOkClickListener);
        builder.setNegativeButton(""+context.getResources().getText(R.string.cancle), onCancleClickListener);
        return builder;
    }
    ...
    public static AlertDialog.Builder getSelectDialog(Context context, String title, String[] arrays, DialogInterface.OnClickListener onClickListener) {
        ...
        builder.setPositiveButton(""+context.getResources().getText(R.string.cancle), null);
        return builder;
    }
