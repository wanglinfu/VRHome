...
public class ReadPFX {
    ...
    public static PrivateKey GetPvkformPfx(InputStream inputStream, String strPassword){
        try {
     ...
     */
    public static String generateSHA1withRSASigature(PrivateKey privateKey, String src)
    {
        try
        {
...
//            RSAPrivateKey privateKey = (RSAPrivateKey) fac.generatePrivate(keySpec);
            ...
            String strBase64 = new String(Base64.encode(signature, Base64.DEFAULT));
            return  URLEncoder.encode(strBase64);
        }
        catch (Exception e)
        {
            e.printStackTrace();
