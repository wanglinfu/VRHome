...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        // 执行创建表的SQL语句
        db.execSQL("CREATE TABLE IF NOT EXISTS recentlycity (id integer primary key, name varchar(40), cid varchar(40) , date INTEGER)");
        db.execSQL("CREATE TABLE IF NOT EXISTS allcity (id integer primary key, name varchar(40),cid varchar(40), pinyin varchar(40))");
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS recentlycity");
        db.execSQL("DROP TABLE IF EXISTS allcity");
        onCreate(db);
