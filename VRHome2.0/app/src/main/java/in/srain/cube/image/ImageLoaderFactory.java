...
public class ImageLoaderFactory {
    ...
    private static String DEFAULT_FILE_CACHE_DIR = "in.srain.cube-image";
    private static String STABLE_FILE_CACHE_DIR = "in.srain.cube-image-stable";
